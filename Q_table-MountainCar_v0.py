...
DISCRETE_OS_SIZE = np.array([20, 20])
...
num_states = [20, 20]
Q = np.random.uniform(low=-2, high=0, size=(num_states + [env.action_space.n]))#Q table (20,20,3) [position,velocity,action]=action_possible
    ...
    for i in range(episodes):
        ...
        while done != True:               
            ...
            # Adjust Q value for current state
                ...
                Q[state_adj[0], state_adj[1],action] += delta #下标为准
...
# Run Q-learning algorithm
rewards, reach = QLearning(env, 0.2, 0.99,3000)
